  ...
  const mockTestimonials = [
    {
      ...
      name: 'Sarah K.',
      role: 'Café Owner',
      quote: "Before Endless, our Instagram looked abandoned. Now it's our #1 way new customers find us. The transformation was faster than I expected.",
      stars: 5,
      avatar: 'SK'
    },
    {
      ...
      quote: "Professional, fast, and actually creative. I stopped worrying about content entirely. They understood our brand from day one and ran with it.",
      stars: 5,
      avatar: 'MD'
    },
    {
      ...
      quote: "Our follower count doubled in 3 months. The posters they design are genuinely stunning — clients ask us who does our social media all the time.",
      stars: 5,
      avatar: 'LT'
    }
  ];
          ...
          <div key={testi.id} className="bg-white rounded-2xl border border-[#E2E8F0] shadow-sm hover:shadow-md transition-shadow p-6 lg:p-8 flex flex-col h-full group">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <button onClick={() => setIsDeleteModalOpen(true)} className="p-1.5 text-[#64748B] hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors">
            ...
            <div className="flex items-center gap-3 pt-4 border-t border-[#F1F5F9] mt-auto">
              <div className="w-10 h-10 rounded-full bg-[#EFF6FF] flex items-center justify-center font-bold text-[#2563EB] flex-shrink-0 text-sm">
                {testi.avatar}
              </div>
              <div>
